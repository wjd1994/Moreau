...
<li>
<ul class="ul1"><p class="p1" style="color:#ff0202">薪资</p></ul>
<ul class="ul2"><p class="p2" id="moreau" style="color:#ff0202"></p></ul>
</li>
<li>
...
<ul>
<li>
<a class="backa" href="offer.do" style="text-decoration:none;color:blue;"><&nbsp&nbsp返回</a>
